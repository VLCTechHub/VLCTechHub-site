...
// staging
//var baseURL = 'http://vlctechhub-api-staging.com/v0/';
...
Ember.Handlebars.registerBoundHelper('linkToCalendar', function(anEvent) {
  ...
  var startDate = new Date(anEvent.date);
  var endDate = new Date(anEvent.date);
  endDate.setHours(endDate.getHours() + 1);
  var dates = isoDate(startDate) + '/' + isoDate(endDate);
  var link = '<a class="link-to-calendar" href="http://www.google.com/calendar/event?action=TEMPLATE&text=' + title + '&dates=' + dates + '&details='+ details + '" target="_blank" title="Añadir a Google Calendar"><img alt="Añadir a Google Calendar" src="img/calendar-24.png"/></a>';
